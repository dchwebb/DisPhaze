...
private:
	...
	static constexpr std::string_view productString 		= "Mountjoy DisPhaze";
	static constexpr std::string_view cfgString 			= "Mountjoy DisPhaze Config";
	static constexpr std::string_view cdcString 			= "Mountjoy DisPhaze Serial";
	static constexpr std::string_view midiString			= "Mountjoy DisPhaze MIDI";
	...
	static constexpr uint16_t ProductId = 65445;
